...
## RUN THE docker-compose.spark docker-compose file to run all the services. But make sure you have the required jars(Iceberg runtime jar for spark, postgresdb jdbc jar for hive metastore) in place. 
